...
#ИСПРАВИТЬ ОТКРЫТИЕ ПРОГРАММ НА РАЗНЫХ ЯЗЫКАХ
#ИСПРАВИТЬ ВОЗМОЖНОСТЬ ОТКРЫВАТЬ ЛОКАЛЬНЫЕ ПАПКИ\ФАЙЛЫ\ПРИЛОЖЕНИЯ ДАННОГО ПК
#ИСПРАВИТЬ СВАРАЧИВАНИЕ НУЖНОГО ОКНА\ЗАКРЫТИЕ ПРОГРАММ WINDOWS 10\ВО ВЕСЬ ЭКРАН